...
print("Private Subnet: " + privsubnet['Subnet']['SubnetId'])
ec2 = boto3.resource('ec2', region_name='us-west-2')
instance = ec2.create_instances(ImageId="ami-0747e613a2a1ff483", InstanceType="t2.micro", SubnetId=privsubnet['Subnet']['SubnetId'], SecurityGroupIds=[sg['GroupId'] ,], KeyName="vockey", MinCount=1, MaxCount=1, TagSpecifications=[{'ResourceType': 'instance', 'Tags': [{'Key': 'Name', 'Value': 'boto3subnet'},]},])
print(instance)